...
email = 'accounts@webpeople.in'

print(common.CheckEmailValidity(email))


'''

response= requests.get('https://www.sulekha.com/finance-accounting-classes/allahabad')
status= response.status_code
print(status)

link = "IndustrialDryCleaners & LaundryServices"
